...
if (isset($_POST['findsign'])) {
  echo '<script language="javascript">';
    echo 'alert("По Вашему запросу ничего не найдено. Повторите попытку позже или обратитесь к нам.")';
    echo '</script>';
}
if (isset($_POST['f2'])) {
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-lg-12 center d-flex justify-content-center">
                        <form action="" method="post">
                          <ul class="fr ">
                            <li id="frmarker"><button type="submit" name="f2"><i class="fa fa-text-width"></i> Текст -> Язык жестов <i class="fa fa-american-sign-language-interpreting"></i></button></li>
                          <li id="fr2"><button type="submit" name="f1"><i class="fa fa-american-sign-language-interpreting"></i> Язык жестов -> Текст <i class="fa fa-text-width"></i></button></li>
                    ...
                    <div class="member-card pt-2 pb-2">
                      <form action="" method="post">
                        <div class="justify-content-left d-flex">
                          ...
                          <button name="findsign" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light" style="margin-top: 4rem!important;height: 100px;margin-left: 20px"><i class="fa fa-sign-language" style="font-size: 50px;"></i> Перевести</button>
                        </div>
                      </form>
                    </div>
                </div>
