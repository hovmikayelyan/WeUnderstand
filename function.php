...
if (isset($_POST["lesson"])) {
  header("Location: https://weunderstand.ru/lesson.php");
}
if (isset($_POST["videolesson"])) {
  header("Location: https://weunderstand.ru/videolesson.php");
}
if (isset($_POST["teacher"])) {
  header("Location: https://weunderstand.ru/allusers.php");
}
if (isset($_POST["creategif"])) {
  header("Location: https://weunderstand.ru/creategifs.php");
}
if (isset($_POST["translateor"])) {
...
<div class="content">
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="">
                            <h4>Доступные мастер-классы</h4>
                        </div>
                        <button name="lesson" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Перейти </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="">
                            <h4>Видеокурс "Мастер жестов"</h4>
                        </div>
                        <button name="videolesson" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Перейти</button>
                    </div>
                </div>
            </div>
            <!-- end col -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto"><i class="fa fa-language" style="font-size: 60px;"></i></div>
                        <div class="">
                            <h4>Переводчик жестов</h4>
                        </div>
                        <button name="translateor" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Перейти</button>
                    </div>
                </div>
            </div>
            <!-- end col -->
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto"><img src="images/gifchik.png" style="width: 60px;height: 60px;" alt=""></div>
                        <div class="">
                        <h4>Создание новых гифов</h4>
                        </div>
                        <button name="creategif" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Перейти</button>
                    </div>
                </div>
            </div>
            <!-- end col -->
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <div class="thumb-lg member-thumb mx-auto"><i class="fa fa-black-tie" style="font-size: 60px;"></i></div>
                            <h4>Найти учителя </h4>
                        </div>
                        <button name="teacher" type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light">Перейти </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
