...
<div class="content">
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <p>Курс жестового языка, Урок 1</p>
                        <div class="">
      ...
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                   <p>Курс жестового языка, Урок 2</p>
                        <div class="">
                            <video width="320" height="240" controls>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <p>Курс жестового языка, Урок 3</p>
                        <div class="">
                            <video width="320" height="240" controls>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <p>Курс жестового языка, Урок 4</p>
                        <div class="">
                            <video width="320" height="240" controls>
      ...
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <p>Курс жестового языка, Урок 5</p>
                        <div class="">
                            <video width="320" height="240" controls>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <p>Курс жестового языка, Урок 6</p>
                        <div class="">
                            <video width="320" height="240" controls>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                         <p>Курс жестового языка, Урок 7</p>
                        <div class="">
                            <video width="320" height="240" controls>
                              <source src="videos/video4.mp4" type="video/mp4">
                            Your browser does not support the video tag.
      ...
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="">
                            <h1>Новые видеоуроки будут очень скоро.</h1>
                        </div>
