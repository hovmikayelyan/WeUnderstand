...
<div class="content">
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto"><img src="images/sas.png" alt="profile-image" height="80" width="80"></div>
                        <div class="">
                            <h4>Sas Supermarket</h4>
                            <span>Сеть супермаркетов</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="https://www.sas.am" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="mx-auto d-flex justify-content-center" style="height: 90px;"><img src="images/supermarket.svg" alt="profile-image" style="width: 150px;"></div>
                        <div class="">
                            <h4>Supermarket.am</h4>
                            <span>Сеть онлайн супермаркетов</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="https://supermarket.am" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto d-flex justify-content-center"><img src="images/clean.jpeg" alt="profile-image" width="120px" height="80px"></div>
                        <div class="">
                            <h4>Clean.am</h4>
                            <span>Услуги профессиональной уборки</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="https://www.cleaning.am" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto d-flex justify-content-center"><img src="images/cooking.jpg" alt="profile-image" height="100px" width="100px"></div>
                        <div class="">
                            <h4>Cooking.am</h4>
                            <span>Сервис для приготовления еды дома</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="#" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
      <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class="thumb-lg member-thumb mx-auto d-flex justify-content-center"><img src="images/books.png" alt="profile-image" width="100px height100px"></div>
                        <div class="">
                            <h4>Bookinist</h4>
                            <span>Сеть онлайн книжного магазина</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="https://www.books.am" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
            <div class="col-lg-4">
                <div class="text-center card-box">
                    <div class="member-card pt-2 pb-2">
                        <div class=""><img src="images/pharm1.png" alt="profile-image" style="width: 200px; height: 89px;"></div>
                        <div class="">
                            <h4>AlfaPharm</h4>
                            <span>Интернет-аптека AlfaPharm</span>
                        </div>
                        <button type="button" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light"><a href="http://alfapharm.am/am" target="_blank">Открыть сайт</a> </button>
                    </div>
                </div>
            </div>
            <!-- end col -->
